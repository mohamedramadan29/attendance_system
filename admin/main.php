...
<div class="content-wrapper">
    ...
    // START About us
    if ($dir == 'about_us' && $page == 'add') {
        include "about_us/add.php";
    } elseif ($dir == 'about_us' && $page == 'edit') {
        include "about_us/edit.php";
    } elseif ($dir == 'about_us' && $page == 'delete') {
        include 'about_us/delete.php';
    } elseif ($dir == 'about_us' && $page == 'report') {
        include "about_us/report.php";
    }
    // START Main Banner 
    if ($dir == 'main_banner' && $page == 'add') {
        include "main_banner/add.php";
    } elseif ($dir == 'main_banner' && $page == 'edit') {
        include "main_banner/edit.php";
    } elseif ($dir == 'main_banner' && $page == 'delete') {
        include 'main_banner/delete.php';
    } elseif ($dir == 'main_banner' && $page == 'report') {
        include "main_banner/report.php";
    }
    ?>
